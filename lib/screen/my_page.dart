    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          children: [
            Icon(
              Icons.person, color: Colors.deepOrange, size: 30, // 아이콘 색상 설정
            ),
            Text("${_student['studentName']} 학생 인적 사항",
                style: TextStyle(
                  fontSize: 18,
                  fontFamily: "NamuL",
                )),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child:
                                  Text("${_student['studentBirth'] ?? '미입력'}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "NamuL",
                                      )),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child:
                                  Text("${_student['studentGender'] ?? '미입력'} ",
                                      style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "NamuL",
                                      )),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child:
                                  Text("${_student['studentPhone'] ?? '미입력'}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "NamuL",
                                      )),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child:
                                  Text("${_student['parentsPhone'] ?? '미입력'}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "NamuL",
                                      )),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child:
                                  Text("${_student['studentAddress'] ?? '미입력'}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "NamuL",
                                      )),
                      ...
                      ElevatedButton.icon(
                        onPressed: () async {
                          ...
                          final updatedData = await Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  MyPageUpdate(studentData: _student),
                            ),
                          );
                          if (updatedData != null) {
                            setState(() {
